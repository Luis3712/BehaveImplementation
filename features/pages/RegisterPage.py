...
class RegisterPage(BasePage):
    ...
    password_confirmation_field_id = "input-confirm"
    ...
    def enter_confirm_password(self, password_text):
        self.type_into_element("password_confirmation_field_id", self.password_confirmation_field_id, password_text)
    ...
    def display_status_of_duplicate_email_waring_message(self, expected_warning_text):
        return self.retrieved_element_text_contains("duplicate_email_warning_message_xpath", self.duplicate_email_warning_message_xpath, expected_warning_text)

    def display_status_of_all_warnings_messages(self, expected_privacy_warning, expected_first_name_warning, expected_last_name_warning, expected_email_warning, expected_telephone_warning, expected_password_warning):
        ...
        self.return_and_status(privacy_status, first_name_status, last_name_status, email_status, telephone_status, password_status)